            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="col col-social-icons">
                        <h4>Síguenos</h4>
                        <a href="https://www.facebook.com/elpapaenvillavicencio/" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="#"  target="_blank"   ><i class="fa fa-twitter"></i></a>
                        <a href="https://www.youtube.com/channel/UC-mQzyZ_nyInJGhNELJcDnA" target="_blank" ><i class="fa fa-youtube-play"></i></a>
                 ...
                 <div class="col-md-4">
                    <div class="col">
                        ...
                        <p class="no-margin">
                            Este sitio web es administrado por la Arquidiócesis de Villavicencio. Para mayor información visita 
                            <a href="https://www.arquidiocesisdevillavicencio.org.co" target="_blank">Arquidiócesis de Villavicencio</a>
